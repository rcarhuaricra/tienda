...
insert  into `persona`(`ID_PERSONA`,`USER`,`NOMBRES`,`APELLIDO_PATERNO`,`APELLIDO_MATERNO`,`ID_TIPO_DOCUMENTO`,`NUMERO_DOCUMENTO`,`DIRECCIÓN`,`TELEFONO`,`EMAIL`,`PASSWORD`,`USER_REG`,`FEC_REG`,`ID_TIPO_PERSONA`) values (1,'MCALLA','MAYKOL HENRY','CALLA','SOLIER',1,'98765432','Av. Perú','987654321','M.CALLA@LA44.COM','e10adc3949ba59abbe56e057f20f883e','RICV','2017-08-06 10:45:26',1),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-08-06 10:45:27',NULL);
