...
insert  into `categoria_producto`(`ID_CATEGORIA_PRODUCTO`,`NOMBRE_CATEGORIA_PRODUCTO`,`USERREG`,`FECREG`,`USERMOD`,`FECMOD`) values ('107C6BDF-AADD-497D-BA47-9429A9','luces',NULL,NULL,NULL,NULL),('2C62513A-5D3F-46F1-A62B-4B8AB1','Redes',NULL,NULL,NULL,NULL),('3B95D65C-88BE-4812-81AB-7F8B78','Pegamentos',NULL,NULL,NULL,NULL),('ED24A0C9-214D-47CC-8262-94E5CF','RELAY',NULL,NULL,NULL,NULL),('F5F2684B-BAB7-42B4-9120-A4BF55','FRENOS',NULL,NULL,NULL,NULL);
...
insert  into `marca`(`ID_MARCA`,`NOMBRE_MARCA`,`USERREG`,`FECREG`,`USERMOD`,`FECMOD`) values ('07817EF7-BF95-45BA-8C9F-7939B7','OKAS',NULL,NULL,'M.CALLA','2017-09-11 22:42:38'),('470A258F-BEF1-4CE3-873B-8A238C','DAVIDS',NULL,NULL,'M.CALLA','2017-09-10 18:53:20'),('4FB5FA82-90D5-4FAF-A394-BFAACA','TP-LINK',NULL,NULL,'M.CALLA','2017-09-11 22:42:54'),('F56A4CC7-6B6B-4084-BB37-6E6177','BETUN','M.CALLA','2017-09-10 18:31:30','M.CALLA','2017-09-10 23:09:31');
...
insert  into `menus`(`id`,`parent`,`name`,`icon`,`slug`,`number`) values (1,NULL,'Inicio','glyphicon glyphicon-home','dashboard',1),(2,NULL,'Almacen','glyphicon glyphicon-barcode','almacen',2),(8,2,'Nuevo Producto','fa fa-circle-o','almacen/newproductos',2),(6,NULL,'Contactos','icofont icofont-brand-live-messenger','contactos',4),(3,NULL,'Facturación','icofont icofont-basket','facturacion',5),(5,NULL,'Reportes','icofont icofont-growth','reportes',6),(9,2,'Productos','fa fa-circle-o','almacen/productos',1),(7,NULL,'Configuración','icofont icofont-gears','configuracion',10),(13,6,'Clientes','icofont icofont-student-alt','contactos/clientes',1),(14,6,'Proveedores','icofont icofont-man-in-glasses','contactos/proveedores',2),(11,3,'Nueva Venta','icofont icofont-ui-cart','facturacion/nuevo',1),(12,3,'Administrar Facturas','fa fa-circle-o','facturacion/administrar',2),(17,5,'Reporte de Ventas','icofont icofont-chart-histogram-alt','reportes/ventas',1),(18,5,'Reporte de Compras','icofont icofont-chart-histogram','reportes/compras',2),(19,5,'Reporte de Inventario','icofont icofont-chart-bar-graph','reportes/inventario',3),(10,2,'Marcas','fa fa-circle-o','almacen/marcas',3),(15,4,'Historial de Compras','fa fa-circle-o','compras/historial',1),(16,4,'Nueva Compra','fa fa-circle-o','compras/newCompra',2),(4,NULL,'Compras','fa fa-truck','compras',1);
...
insert  into `persona`(`ID_PERSONA`,`USER`,`NOMBRES`,`APELLIDO_PATERNO`,`APELLIDO_MATERNO`,`ID_TIPO_DOCUMENTO`,`NUMERO_DOCUMENTO`,`CUMPLEAÑOS`,`DIRECCION`,`TELEFONO`,`EMAIL`,`PASSWORD`,`PERSONA_CONTACTO`,`ID_TIPO_PERSONA`,`USERREG`,`FECREG`,`USERMOD`,`FECMOD`,`USERESTADO`) values ('0000000000000000000000001-2017','M.CALLA','MAYKOL HENRY','CALLA','SOLIER',1,'98765421',NULL,'','987654322','M.CALLA@LA44.COM','e10adc3949ba59abbe56e057f20f883e','',1,'RICV','2017-08-06 10:45:26','0000000000000000000000001-2017','2017-08-27 16:15:38','1'),('0000000000000000000000002-2017','','RICV','','',2,'10459146585','0000-00-00 00:00:00','LIMA','964727438','RONALD.CARHUARICRA@GMAIL.COM','','RONALD IVAN CARHUARICRA',4,'0000000000000000000000001-2017','2017-09-09 17:10:00',NULL,NULL,'1');
...
insert  into `producto`(`ID_PRODUCTO`,`CODIGO_BARRAS`,`NOMBRE_PRODUCTO`,`ID_MARCA`,`ID_CATEGORIA_PRODUCTO`,`DESCRIPCION_PRODUCTO`,`IMG_PRODUCTO`,`USERREG`,`FECREG`,`USERMOD`,`FECMOD`) values ('0000000000000000000000001-2017','7751426000565','Goma transparente','470A258F-BEF1-4CE3-873B-8A238C','3B95D65C-88BE-4812-81AB-7F8B78','Pegamento David 25ccc','7751426000565.jpg','0000000000000000000000001-2017','2017-09-06 23:26:12','M.CALLA','2017-09-10 23:17:45'),('0000000000000000000000002-2017','2169112006392','Routere','4FB5FA82-90D5-4FAF-A394-BFAACA','2C62513A-5D3F-46F1-A62B-4B8AB1','5 puertos ','2169112006392.jpg','0000000000000000000000001-2017','2017-09-07 00:47:29','M.CALLA','2017-09-10 23:12:26'),('0000000000000000000000003-2017','7750034000011','Betún','07817EF7-BF95-45BA-8C9F-7939B7','2C62513A-5D3F-46F1-A62B-4B8AB1','Negro santiago','7750034000011.jpg','M.CALLA','2017-09-10 17:24:21','M.CALLA','2017-09-10 17:25:28');
...
/* Procedure structure for procedure `updateProducto` */

/*!50003 DROP PROCEDURE IF EXISTS  `updateProducto` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`ricvpe`@`localhost` PROCEDURE `updateProducto`(IN p1 VARCHAR (13),IN p2 VARCHAR (60),IN p3 VARCHAR (30),IN p4 VARCHAR (30), IN p5 VARCHAR(300), IN p6 VARCHAR(100), IN p7 VARCHAR (35))
BEGIN
    update `producto`
    set
    `NOMBRE_PRODUCTO`= p2
    , `ID_MARCA`=p3
    ,`ID_CATEGORIA_PRODUCTO`=p4
    ,`DESCRIPCION_PRODUCTO`=p5
    ,`USERMOD`=p7
    ,`FECMOD`= now()
    where `CODIGO_BARRAS`=p1;
